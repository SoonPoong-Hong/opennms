...
public class JnaPingTest {
    private static final JnaPinger s_jnaPinger = new JnaPinger();
    ...
    public void testParallelPingIPv4() throws Exception {
        doParallelPingGood(m_goodHost);
    }

    @Test
    public void testParallelPingIPv6() throws Exception {
        doParallelPingGood(m_ipv6goodHost);
    }

    @Test
    public void testParallelPingFailureIPv4() throws Exception {
        doParallelPingFailure(m_badHost);
    }

    @Test
    public void testParallelPingFailureIPv6() throws Exception {
        doParallelPingFailure(m_ipv6badHost);
    }

    private void doSinglePingGood(final InetAddress addr) throws Exception {
    ...
    private void doPingCallbackTimeout(final InetAddress addr) throws Exception {
    ...
    private void doParallelPingGood(final InetAddress addr) throws Exception {
    ...
    private void doParallelPingFailure(final InetAddress addr) throws Exception {
        final List<Number> items = s_jnaPinger.parallelPing(addr, 20, PingConstants.DEFAULT_TIMEOUT, 50);
        printResponse(items);
